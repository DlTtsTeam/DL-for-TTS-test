...
outputs = layers.Dense(o_size, activation=tf.nn.softmax, name="layer2")(outputs)
...
cb_tensorboard = tf.keras.callbacks.TensorBoard(log_dir='./summary/nn2', histogram_freq=1, write_grads=True, \
